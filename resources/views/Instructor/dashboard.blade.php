...
@section('content')
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 dash-card p-0 overflow-hidden">   
            <div class="p-5 border-b border-gray-100 flex justify-between items-center"><h3 class="font-display font-bold text-black">Student Performance Assessment</h3><select class="text-xs border border-gray-200 rounded-lg px-3 py-1.5 bg-white text-gray-600 focus:outline-none"><option value="">All Sections</option>@foreach($sections as $sec)<option value="{{ $sec }}">{{ $sec }}</option>@endforeach</select></div>
            <table class="w-full text-left text-sm">
                <thead class="bg-gray-50 text-xs text-gray-400 uppercase tracking-wider"><tr><th class="p-4">Student</th><th class="p-4">Module Assessment Total</th><th class="p-4">Final Marksmanship Assessment Final Score</th><th class="p-4">Status</th></tr></thead>
                <tbody class="divide-y divide-gray-50">
                    <tr class="hover:bg-gray-50 transition-colors"><td class="p-4 font-medium text-black">Dela Cruz, Juan</td><td class="p-4 text-green-500 font-semibold">93%</td><td class="p-4 text-violet-600 font-semibold">87%</td><td class="p-4"><span class="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-bold rounded">Passing</span></td></tr>
                    <tr class="hover:bg-gray-50 transition-colors"><td class="p-4 font-medium text-black">Santos, Ana</td><td class="p-4 text-green-500 font-semibold">94%</td><td class="p-4 text-violet-600 font-semibold">91%</td><td class="p-4"><span class="px-2 py-0.5 bg-green-100 text-green-700 text-[10px] font-bold rounded">Passing</span></td></tr>
                    <tr class="hover:bg-gray-50 transition-colors bg-red-50/30"><td class="p-4 font-medium text-black">Garcia, Pedro</td><td class="p-4 text-orange-500 font-semibold">66%</td><td class="p-4 text-red-500 font-semibold">54%</td><td class="p-4"><span class="px-2 py-0.5 bg-red-100 text-red-700 text-[10px] font-bold rounded">Needs Attention</span></td></tr>
                </tbody>
            </table>
